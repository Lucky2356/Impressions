...
class AppConfig {
  ...
  /// Как часто приложение делает копию само, в днях.
  ///
  /// Копии создавались только перед импортом, перед восстановлением и по
  /// кнопке — то есть у человека, который ничего из этого не делает, их не
  /// было вовсе. Всё хранится на одном устройстве, и терять записи из-за
  /// того, что о копии никто не подумал, нельзя.
