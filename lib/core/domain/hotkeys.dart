...
///
/// Список показывается человеку, поэтому обещать в нём можно только то, что
/// работает: Ctrl + E вёл в «Профили», то есть делал ровно то же, что Ctrl + P,
/// а Ctrl + K и Ctrl + A в нём вовсе не значились.
List<Hotkey> appHotkeys(AppLocalizations l10n) => [
  (keys: 'Ctrl + N', label: l10n.hotkeyNewEntry),
  (keys: 'Ctrl + K', label: l10n.hotkeyPalette),
  ...
  (keys: 'Ctrl + A', label: l10n.hotkeySelectAll),
