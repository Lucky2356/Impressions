...
/// * Android — файл лежит в приватном каталоге приложения. Своего шифрования
///   там нет: `osProtected` истинно только на Windows, поэтому секрет защищён
///   ровно тем, что каталог приложения недоступен другим приложениям и не
///   уходит с устройства — `allowBackup="false"` и `data_extraction_rules.xml`
///   закрывают и облачную копию, и перенос на новый телефон.
///
