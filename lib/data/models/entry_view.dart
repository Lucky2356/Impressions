...
/// Задуманное, до которого не дошли руки: сколько и с каких пор.
///
/// Отдельно от [ProfileStats]: той нужен только счёт для плитки на главной, а
/// напоминанию — ещё и давность, чтобы молчать про заведённое на этой неделе.
class PlannedWaiting {
  const PlannedWaiting({required this.count, this.since});

  final int count;

  /// Когда завели самую давнюю задумку. `null`, если задуманного нет.
