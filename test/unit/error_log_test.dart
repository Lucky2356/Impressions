// Журнал пишется с принудительным сбросом на диск — иначе запись об аварии
// не переживёт саму аварию. Проверка предела делает четыре сотни таких записей
// подряд, и на занятой машине они не укладываются в обычные тридцать секунд:
// тесты падали при полном прогоне и проходили поодиночке.
