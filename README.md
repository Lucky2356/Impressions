...
**Запоминать быстро.** Для новой записи хватает названия и Enter. Форма помнит, куда вы клали прошлую, и подставляет ту же категорию — записи подряд обычно ложатся в одно место. Дальше — отношение от «обожаю» до «избегаю», оценка одним касанием по числу, заметка, дата впечатления, фотографии, теги и подборка: всё в одной форме, без повторного открытия записи. Снимок можно перетащить прямо в окно, а выбранная обложка видна на карточке в каталоге. Каждое изменение сохраняется отдельной версией, любую можно вернуть.
...
**Жить в системе.** Файл обмена открывается двойным щелчком на компьютере и через «Поделиться» на телефоне; окно помнит свой размер и положение; длинное нажатие на значок предлагает завести запись или отсканировать штрихкод.
...
Раз в неделю приложение делает резервную копию само — это выключается в настройках. Копии лежат рядом с базой, но там не запираются: кнопка «Сохранить к себе» выкладывает копию наружу — на компьютере в выбранную папку, на телефоне через «Поделиться», — а «Восстановить из файла» разворачивает её обратно даже после переустановки. Перед заменой приложение проверяет копию по контрольным суммам и отдельно сохраняет нынешнее состояние. По желанию копии защищаются паролем — тогда унесённая с устройства копия без него не читается, а на своём устройстве разворачивается без лишних вопросов.
