...
[![Тесты](https://img.shields.io/badge/%D1%82%D0%B5%D1%81%D1%82%D1%8B-150-35B37E)](#для-разработчиков)
...
**Находить.** Полнотекстовый поиск по названиям и по тексту заметок, фильтры по типу, категории, отношению и тегам, четыре порядка сортировки, три режима отображения. Выделив несколько записей, можно разом разложить их по категориям, пометить тегом или убрать в архив.
