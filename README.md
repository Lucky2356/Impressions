...
[![Тесты](https://img.shields.io/badge/%D1%82%D0%B5%D1%81%D1%82%D1%8B-229-35B37E)](#для-разработчиков)
...
Копии лежат рядом с базой и разворачиваются из настроек: перед заменой приложение проверяет копию по контрольным суммам и отдельно сохраняет нынешнее состояние. По желанию копии защищаются паролем — тогда унесённая с устройства копия без него не читается, а на своём устройстве разворачивается без лишних вопросов.
